...
export const StockMovements: React.FC = () => {
  ...
  const translateReason = (reason: string) => {
    switch (reason) {
      ...
      case 'DISINCORPORATION': return 'Desincorporación';
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="hidden lg:table-cell">Ubicación / Tienda</TableHead>
                ...
                <TableRow key={movement.id}>
                  ...
                  <TableCell className="hidden lg:table-cell">
                    ...
                    {location ? (
                      ...
                      <div className="text-xs text-slate-400 italic">Sin ubicación</div>
                    )}
                  </TableCell>
                  <TableCell className="whitespace-nowrap text-slate-600">
                    {user?.name || 'Sistema'}
