...
const DisincorporationPage: React.FC = () => {
  ...
  const handleExportPDF = (d: Disincorporation) => {
    ...
    doc.text('Reporte de Desincorporaci贸n / Merma', 14, 30);
    ...
    autoTable(doc, {
      startY: 65,
      head: [['C贸digo', 'Producto', 'Ubicaci贸n', 'Cant.', 'Motivo', 'Notas']],
      body: tableData,
        ...
        <header className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight">
              {currentDisincorporation.id ? 'Editar Desincorporaci贸n' : 'Nueva Desincorporaci贸n'}
            </h1>
            <p className="text-slate-500 mt-1">Registre la salida de mercanc铆a por mermas o da帽os.</p>
          </div>
        </header>
          ...
          <div className={`${currentDisincorporation.status === 'APPROVED' ? 'lg:col-span-3' : 'lg:col-span-2'} space-y-6`}>
            <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">Descripci贸n / Referencia</label>
                  <Input 
                    value={description}
                    onChange={(e) => setDescription(e.target.value)}
                    placeholder="Ej. Da帽os por inundaci贸n..."
              ...
              <div className="space-y-4">
                ...
                {selectedProduct && (
                  <>
                    ...
                    <div>
                      <label className="block text-xs font-medium text-slate-500 mb-1">Ubicaci贸n de Origen</label>
                      <select 
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        >
                          <option value="DAMAGED">Da帽ado</option>
  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight">Desincorporaci贸n</h1>
          <p className="text-slate-500 mt-2">Gesti贸n de salidas de inventario y mermas.</p>
        </div>
              ...
              {disincorporations.length === 0 && (
                <TableRow>
                  <TableCell colSpan={6} className="py-12 text-center text-slate-500">
                    No hay registros de desincorporaci贸n.
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
      ...
      >
        <div className="space-y-4">
          <div className="flex items-center gap-3 text-amber-600 bg-amber-50 p-3 rounded-xl border border-amber-200">
            ...
            <p className="text-sm font-medium">Esta acci贸n descontar谩 el stock inmediatamente y no se puede deshacer.</p>
          </div>
          <p className="text-slate-600 text-sm">驴Est谩 seguro de que desea procesar esta desincorporaci贸n?</p>
      ...
      >
        <div className="space-y-4">
          <p className="text-slate-600 text-sm">驴Est谩 seguro de que desea eliminar este registro de desincorporaci贸n? Esta acci贸n no se puede deshacer.</p>
          <div className="flex justify-end gap-3 pt-4">
